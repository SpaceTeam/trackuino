...
void Acc::ReadMultipleRegisters(byte addr, byte* receiveBuffer, byte amount)
{
...
byte Acc::WriteRegister(byte addr, byte data)
{
...
void Acc::WriteMultipleRegisters(byte addr, byte amount, byte* data)
{
